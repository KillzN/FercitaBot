...
const handler = async (m, { conn, usedPrefix }) => {
  ...
  const Message = {
    document: { url: `https://www.instagram.com/xmynsi.ff/` },
    ...
    contextInfo: {
      ...
      isForwarded: true,
      externalAdReply: {
        mediaUrl: "https://www.instagram.com/xmynsi.ff/",
        mediaType: 2,
        previewType: "pdf",
        title: "Fercita",
        body: tradutor.texto2,
        thumbnail: imagen1,
        sourceUrl: "https://www.instagram.com/xmynsi.ff/",
      },
    },
    caption: info,
    footer: wm,
